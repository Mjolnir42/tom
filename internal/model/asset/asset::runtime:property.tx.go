...
func (h *RuntimeWriteHandler) txPropUpdate(
	q *msg.Request,
	mr *msg.Result,
	tx *sql.Tx,
	txTime *time.Time,
...
func (h *RuntimeWriteHandler) txPropClamp(
	q *msg.Request,
	mr *msg.Result,
	tx *sql.Tx,
	txTime *time.Time,
...
func (h *RuntimeWriteHandler) txAttrQueryType(
	q *msg.Request,
	mr *msg.Result,
	tx *sql.Tx,
	prop proto.PropertyDetail,
...
func (h *RuntimeWriteHandler) txPropSetValue(
	q *msg.Request,
	mr *msg.Result,
	stmt *sql.Stmt,
	prop proto.PropertyDetail,
