...
func (h *OrchestrationWriteHandler) txPropUpdate(
	q *msg.Request,
	mr *msg.Result,
	tx *sql.Tx,
	txTime *time.Time,
	...
	case `type`:
		// type is allowed to use the `perpetual` keyword
	...
	// was successfully invalidated. Clean future records that have never been
	// valid yet, ie. their validSince is after now()
	if ok = h.txPropClean(
		q,
		mr,
		stmtClean,
...
func (h *OrchestrationWriteHandler) txPropClamp(
	q *msg.Request,
	mr *msg.Result,
	tx *sql.Tx,
	txTime *time.Time,
	...
	if res, err = stmtClamp.Exec(
		...
		// of the new record
		reqValidSince,
		// ID of the orchestration environment
		orchID,
	); err != nil {
		mr.ServerError(err)
		return false, false
...
func (h *OrchestrationWriteHandler) txAttrQueryType(
	q *msg.Request,
	mr *msg.Result,
	tx *sql.Tx,
	prop proto.PropertyDetail,
...
func (h *OrchestrationWriteHandler) txPropSetValue(
	q *msg.Request,
	mr *msg.Result,
	stmt *sql.Stmt,
	prop proto.PropertyDetail,
...
func (h *OrchestrationWriteHandler) txPropClean(
	q *msg.Request,
	mr *msg.Result,
	stmt *sql.Stmt,
	prop proto.PropertyDetail,
