...
func init() {
	...
	registry = append(registry, function{
		cmd:    proto.CmdOrchestrationPropSet,
		handle: orchestrationPropSet,
	})
}

func orchestrationPropSet(m *Model) httprouter.Handle {
	return m.x.Authenticated(m.OrchestrationPropSet)
}

func exportOrchestrationPropSet(result *proto.Result, r *msg.Result) {
	result.Orchestration = &[]proto.Orchestration{}
	*result.Orchestration = append(*result.Orchestration, r.Orchestration...)
}

// OrchestrationPropSet function
func (m *Model) OrchestrationPropSet(w http.ResponseWriter, r *http.Request,
	...
	m.x.Send(&w, &result, exportOrchestrationPropSet)
}

// propertySet ...
func (h *OrchestrationWriteHandler) propertySet(q *msg.Request, mr *msg.Result) {
	var (
