...
func init() {
	proto.AssertCommandIsDefined(proto.CmdTeamMbrList)

	registry = append(registry, function{
		cmd:    proto.CmdTeamMbrList,
		handle: teamMemberList,
	})
}

func teamMemberList(m *Model) httprouter.Handle {
	return m.x.Authenticated(m.TeamMemberList)
}

func exportTeamMemberList(result *proto.Result, r *msg.Result) {
...
func (m *Model) TeamMemberList(w http.ResponseWriter, r *http.Request,
	...
	m.x.Send(&w, &result, exportTeamMemberList)
}
