...
func init() {
	proto.AssertCommandIsDefined(proto.CmdTeamMbrRemove)

	registry = append(registry, function{
		cmd:    proto.CmdTeamMbrRemove,
		handle: teamMemberRemove,
	})
}

func teamMemberRemove(m *Model) httprouter.Handle {
	return m.x.Authenticated(m.TeamMemberRemove)
}

func exportTeamMemberRemove(result *proto.Result, r *msg.Result) {
...
func (m *Model) TeamMemberRemove(w http.ResponseWriter, r *http.Request,
	...
	m.x.Send(&w, &result, exportTeamMemberRemove)
}
