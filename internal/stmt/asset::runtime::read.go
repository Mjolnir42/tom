...
SELECT            asset.runtime_environment.rteID,
                  ...
                  asset.runtime_environment_standard_attribute_values.value,
                  inventory.user.uid AS createdBy,
                  asset.runtime_environment_standard_attribute_values.createdAt
FROM              meta.dictionary
...
JOIN              asset.runtime_environment_standard_attribute_values
    ON            meta.dictionary.dictionaryID = asset.runtime_environment_standard_attribute_values.dictionaryID
    AND           asset.runtime_environment.rteID = asset.runtime_environment_standard_attribute_values.rteID
...
WHERE             (meta.dictionary.name = $1::text OR $1::text IS NULL)
  ...
  AND             now()::timestamptz(3) <@ asset.runtime_environment_standard_attribute_values.validity;`
