...
func cmdAssetServerPropUpdate(c *cli.Context) error {
	opts := map[string][]string{}
	props := []proto.PropertyDetail{}
	variable, once, required := adm.ArgumentsForCommand(proto.CmdServerPropUpdate)
	...
	spec := adm.Specification{
		Name: proto.CmdServerPropUpdate,
