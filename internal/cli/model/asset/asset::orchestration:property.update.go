...
func cmdAssetOrchestrationPropUpdate(c *cli.Context) error {
	opts := map[string][]string{}
	props := []proto.PropertyDetail{}
	variable, once, required := adm.ArgumentsForCommand(proto.CmdOrchestrationPropUpdate)
	...
	spec := adm.Specification{
		Name: proto.CmdOrchestrationPropUpdate,
