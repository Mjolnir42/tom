...
func cmdAssetContainerPropSet(c *cli.Context) error {
	opts := map[string][]string{}
	props := []proto.PropertyDetail{}
	variable, once, required := adm.ArgumentsForCommand(proto.CmdContainerPropSet)
	...
	spec := adm.Specification{
		Name: proto.CmdContainerPropSet,
