...
func cmdAssetRuntimePropUpdate(c *cli.Context) error {
	opts := map[string][]string{}
	props := []proto.PropertyDetail{}
	variable, once, required := adm.ArgumentsForCommand(proto.CmdRuntimePropUpdate)
	...
	spec := adm.Specification{
		Name: proto.CmdRuntimePropUpdate,
