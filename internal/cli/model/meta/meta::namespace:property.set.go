...
func cmdMetaNamespacePropSet(c *cli.Context) error {
	opts := map[string][]string{}
	props := []proto.PropertyDetail{}
	variable, once, required := adm.ArgumentsForCommand(proto.CmdNamespacePropSet)
	...
	spec := adm.Specification{
		Name: proto.CmdNamespacePropSet,
