...
This command is used to set all properties of a container in a
...
see the `NOTES` section for a list of excempt special properties.
...
```
tom container property set example-db01 namespace inventory property lifecycle_state value end-of-life since 2023-01-01T00:00:00.000Z
```
